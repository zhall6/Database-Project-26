...
--
-- Table structure for table `driver_score`
--

DROP TABLE IF EXISTS `driver_score`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `driver_score` (
  ...
  `rate_comment` varchar(75) DEFAULT NULL,
  PRIMARY KEY (`rating_id`),
  KEY `fk_rating_person2_idx` (`person_id`),
  KEY `fk_rating_order2_idx` (`order_id`),
  KEY `fk_rating_driver2` (`driver_id`),
  CONSTRAINT `fk_rating_driver2` FOREIGN KEY (`driver_id`) REFERENCES `driver` (`driver_id`),
  CONSTRAINT `fk_rating_order2` FOREIGN KEY (`order_id`) REFERENCES `order` (`order_id`),
  CONSTRAINT `fk_rating_person2` FOREIGN KEY (`person_id`) REFERENCES `person` (`person_id`)
) ENGINE=InnoDB AUTO_INCREMENT=101 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `driver_score`
--

LOCK TABLES `driver_score` WRITE;
/*!40000 ALTER TABLE `driver_score` DISABLE KEYS */;
INSERT INTO `driver_score` VALUES (1,110,53,3,5,'velit'),(2,8,41,4,1,'et,'),(3,93,10,5,1,'at lacus. Quisque purus sapien,'),(4,152,47,5,2,'faucibus lectus, a sollicitudin'),(5,170,16,5,5,'Cras convallis convallis dolor.'),(6,6,73,5,3,'Morbi sit amet'),(7,123,71,4,5,'est. Mauris eu'),(8,31,37,2,5,'Morbi quis urna.'),(9,61,3,6,1,'aliquet lobortis, nisi nibh'),(10,65,45,6,2,'neque sed sem egestas blandit.'),(11,106,15,2,5,'arcu. Sed et'),(12,24,22,8,1,'a nunc. In at'),(13,39,3,5,1,'dignissim tempor'),(14,142,34,5,2,'ligula elit, pretium et, rutrum'),(15,140,9,4,3,'hendrerit'),(16,128,42,8,1,'iaculis odio. Nam interdum enim'),(17,100,73,4,3,'mauris sagittis placerat. Cras'),(18,90,100,7,1,'posuere cubilia'),(19,178,10,1,1,'ornare'),(20,5,48,1,1,'ut, molestie in,'),(21,118,91,8,1,'Mauris magna.'),(22,29,86,7,2,'non sapien molestie'),(23,164,4,1,3,'eleifend'),(24,148,53,6,2,'ultrices iaculis'),(25,134,94,2,5,'fringilla est. Mauris'),(26,171,7,7,5,'dapibus rutrum, justo.'),(27,201,10,8,1,'lorem, sit'),(28,66,13,1,1,'lacinia mattis.'),(29,95,43,1,5,'semper'),(30,83,62,6,5,'euismod et, commodo at, libero.'),(31,154,96,6,3,'est mauris, rhoncus id, mollis'),(32,186,76,5,5,'Etiam'),(33,121,62,1,1,'id enim. Curabitur'),(34,8,36,7,5,'diam. Pellentesque habitant'),(35,51,38,1,2,'fermentum vel, mauris.'),(36,182,28,2,5,'imperdiet ullamcorper.'),(37,39,100,1,5,'egestas. Fusce aliquet'),(38,132,32,8,5,'nisi dictum augue'),(39,121,100,7,4,'elit erat'),(40,163,19,8,3,'Donec tempus, lorem'),(41,5,55,2,5,'convallis'),(42,44,68,2,4,'consequat enim diam vel arcu.'),(43,134,57,2,5,'parturient montes, nascetur ridiculus mus.'),(44,136,33,8,1,'tellus id nunc'),(45,142,97,7,2,'orci lobortis augue scelerisque'),(46,157,36,8,4,'placerat eget, venenatis'),(47,142,62,7,4,'pharetra. Nam'),(48,49,70,4,5,'elit pede, malesuada vel, venenatis'),(49,130,69,3,5,'non ante bibendum'),(50,35,49,4,5,'penatibus et magnis dis'),(51,171,37,6,5,'a feugiat tellus lorem eu'),(52,43,13,7,5,'scelerisque sed, sapien. Nunc pulvinar'),(53,32,55,1,5,'eros. Proin ultrices.'),(54,94,89,7,5,'dapibus ligula. Aliquam'),(55,107,67,1,4,'Vivamus euismod urna. Nullam'),(56,180,51,2,1,'elementum purus,'),(57,163,5,1,5,'Fusce mollis.'),(58,23,60,7,2,'at, libero. Morbi accumsan'),(59,142,27,7,5,'dui'),(60,35,62,1,2,'Curabitur massa.'),(61,178,81,4,2,'augue'),(62,132,95,8,1,'dolor'),(63,12,14,6,1,'sodales nisi'),(64,9,27,1,2,'a odio semper'),(65,83,7,7,3,'hendrerit. Donec porttitor'),(66,21,50,6,3,'tempus'),(67,199,55,8,2,'montes, nascetur ridiculus mus.'),(68,101,101,4,3,'mattis velit justo nec ante.'),(69,168,53,2,5,'Nullam scelerisque neque sed'),(70,67,52,1,4,'magna a tortor. Nunc'),(71,53,62,1,2,'dignissim pharetra. Nam ac'),(72,64,60,8,4,'interdum. Curabitur'),(73,11,52,1,1,'egestas. Sed'),(74,29,29,6,2,'velit dui,'),(75,45,60,8,5,'sit amet'),(76,175,22,2,3,'lobortis ultrices. Vivamus rhoncus.'),(77,30,67,1,1,'dictum cursus. Nunc mauris elit,'),(78,164,82,6,4,'velit. Aliquam nisl. Nulla eu'),(79,52,8,2,2,'libero. Integer'),(80,135,51,5,4,'Donec consectetuer mauris'),(81,140,31,3,2,'mus. Donec'),(82,129,100,3,2,'ipsum'),(83,164,53,3,2,'vitae erat vel pede blandit'),(84,97,31,3,2,'faucibus'),(85,163,37,4,3,'morbi tristique senectus et netus'),(86,59,96,1,3,'natoque penatibus et'),(87,157,90,7,1,'Donec vitae erat vel'),(88,31,8,7,3,'pede, ultrices a, auctor'),(89,34,17,8,5,'Cum'),(90,143,99,8,3,'gravida non, sollicitudin a,'),(91,202,98,3,4,'dui, nec'),(92,97,61,7,2,'montes, nascetur ridiculus'),(93,29,85,3,4,'vel turpis. Aliquam adipiscing lobortis'),(94,27,86,4,2,'at, iaculis quis,'),(95,18,32,5,1,'faucibus leo,'),(96,103,65,8,2,'pretium et,'),(97,205,88,4,5,'cubilia Curae; Phasellus ornare. Fusce'),(98,115,27,7,2,'congue. In'),(99,52,81,4,4,'gravida sagittis. Duis'),(100,44,57,4,3,'Cras vehicula aliquet libero. Integer');
/*!40000 ALTER TABLE `driver_score` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `restaurant_score`
--
...
CREATE TABLE `restaurant_score` (
  ...
  `order_id` int NOT NULL,
  `restaurant_id` int NOT NULL,
  `restaurant_score` float DEFAULT NULL,
  `rate_comment` varchar(75) DEFAULT NULL,
  PRIMARY KEY (`rating_id`),
...
--
-- Dumping data for table `restaurant_score`
--

LOCK TABLES `restaurant_score` WRITE;
/*!40000 ALTER TABLE `restaurant_score` DISABLE KEYS */;
INSERT INTO `restaurant_score` (`rating_id`,`person_id`,`order_id`,`restaurant_id`,`restaurant_score`,`rate_comment`) VALUES (1,69,28,62,2,"euismod"),(2,68,75,53,4,"Duis"),(3,41,77,65,1,"ipsum primis in faucibus orci"),(4,105,55,100,2,"id, mollis"),(5,60,72,58,4,"erat semper rutrum. Fusce dolor"),(6,149,40,66,2,"et malesuada fames ac turpis"),(7,73,76,15,1,"Fusce"),(8,60,60,61,2,"nec, diam."),(9,33,59,21,3,"faucibus id,"),(10,152,9,21,1,"Lorem ipsum dolor sit amet,");
INSERT INTO `restaurant_score` (`rating_id`,`person_id`,`order_id`,`restaurant_id`,`restaurant_score`,`rate_comment`) VALUES (11,73,4,98,4,"pretium aliquet,"),(12,134,73,98,3,"interdum. Nunc"),(13,93,92,45,2,"quis"),(14,174,65,23,3,"velit. Sed"),(15,15,74,16,2,"fringilla."),(16,159,3,31,1,"Praesent eu dui."),(17,92,78,89,3,"mattis. Cras eget nisi dictum"),(18,171,39,64,1,"Etiam"),(19,87,55,18,1,"lacus, varius et, euismod"),(20,56,70,71,3,"sed tortor.");
INSERT INTO `restaurant_score` (`rating_id`,`person_id`,`order_id`,`restaurant_id`,`restaurant_score`,`rate_comment`) VALUES (21,172,34,22,2,"feugiat nec, diam."),(22,193,58,65,4,"cursus. Nunc mauris elit,"),(23,189,26,17,5,"vitae"),(24,100,77,37,3,"Proin vel"),(25,33,7,97,4,"leo elementum"),(26,3,35,17,4,"Fusce dolor"),(27,19,5,83,2,"dis parturient montes,"),(28,96,29,26,1,"Vestibulum ante ipsum primis"),(29,108,74,30,4,"magnis dis parturient montes,"),(30,128,30,52,4,"magnis dis parturient montes,");
INSERT INTO `restaurant_score` (`rating_id`,`person_id`,`order_id`,`restaurant_id`,`restaurant_score`,`rate_comment`) VALUES (31,144,65,27,2,"imperdiet"),(32,184,87,4,5,"Nullam"),(33,41,89,20,5,"diam. Proin dolor."),(34,188,73,27,4,"Donec est mauris,"),(35,171,42,67,4,"lobortis risus."),(36,89,98,43,5,"nulla"),(37,137,22,17,4,"vel turpis."),(38,89,30,74,2,"vitae dolor. Donec fringilla."),(39,138,94,38,2,"et ultrices"),(40,180,4,5,3,"posuere cubilia Curae; Donec");
INSERT INTO `restaurant_score` (`rating_id`,`person_id`,`order_id`,`restaurant_id`,`restaurant_score`,`rate_comment`) VALUES (41,50,30,3,1,"Cum sociis natoque penatibus"),(42,76,77,66,5,"Fusce aliquam,"),(43,156,53,48,3,"lectus sit amet"),(44,196,14,16,5,"imperdiet dictum magna. Ut tincidunt"),(45,134,86,23,2,"Sed"),(46,46,70,35,4,"in magna. Phasellus dolor elit,"),(47,1,52,68,4,"egestas a,"),(48,13,68,70,4,"libero."),(49,147,52,41,2,"enim. Mauris quis turpis"),(50,116,84,48,1,"risus. Nulla eget");
INSERT INTO `restaurant_score` (`rating_id`,`person_id`,`order_id`,`restaurant_id`,`restaurant_score`,`rate_comment`) VALUES (51,174,25,62,3,"Mauris blandit enim"),(52,89,93,48,2,"elementum, lorem ut aliquam"),(53,30,89,42,1,"adipiscing ligula. Aenean"),(54,29,10,39,2,"porttitor interdum. Sed auctor"),(55,94,98,17,5,"egestas a,"),(56,29,1,30,4,"rhoncus. Nullam"),(57,138,1,43,1,"Cras dolor dolor,"),(58,86,22,75,4,"nascetur ridiculus"),(59,62,73,45,3,"ut"),(60,168,62,3,2,"non arcu.");
INSERT INTO `restaurant_score` (`rating_id`,`person_id`,`order_id`,`restaurant_id`,`restaurant_score`,`rate_comment`) VALUES (61,85,40,51,3,"pellentesque. Sed dictum."),(62,109,81,92,3,"magnis"),(63,126,24,30,2,"risus varius orci,"),(64,138,47,19,2,"tincidunt congue turpis. In condimentum."),(65,159,94,5,5,"mollis nec, cursus"),(66,8,63,70,5,"Mauris"),(67,121,45,83,1,"tincidunt. Donec vitae"),(68,30,90,23,1,"vitae, sodales at, velit. Pellentesque"),(69,23,68,78,3,"fermentum arcu. Vestibulum ante ipsum"),(70,63,10,64,4,"et pede. Nunc sed");
INSERT INTO `restaurant_score` (`rating_id`,`person_id`,`order_id`,`restaurant_id`,`restaurant_score`,`rate_comment`) VALUES (71,165,3,44,4,"egestas ligula. Nullam feugiat placerat"),(72,205,89,44,1,"dapibus gravida. Aliquam tincidunt, nunc"),(73,153,23,35,3,"massa"),(74,125,59,28,5,"molestie pharetra"),(75,199,45,46,2,"Proin dolor. Nulla"),(76,180,92,33,1,"lacus. Ut nec"),(77,201,22,5,1,"ac nulla. In tincidunt congue"),(78,84,21,24,1,"eu tellus eu"),(79,122,59,78,1,"Ut tincidunt vehicula"),(80,54,27,80,5,"cursus a,");
INSERT INTO `restaurant_score` (`rating_id`,`person_id`,`order_id`,`restaurant_id`,`restaurant_score`,`rate_comment`) VALUES (81,43,10,23,3,"enim. Mauris quis turpis vitae"),(82,2,28,16,2,"diam. Pellentesque"),(83,148,11,65,1,"dolor."),(84,13,93,75,2,"ultricies ornare, elit elit fermentum"),(85,188,37,57,4,"quis, tristique ac, eleifend"),(86,69,55,30,5,"ut nisi a"),(87,97,25,14,3,"tincidunt congue"),(88,204,45,12,4,"Donec est mauris, rhoncus"),(89,180,37,67,4,"Curae; Donec tincidunt."),(90,3,31,71,1,"ut, pellentesque");
INSERT INTO `restaurant_score` (`rating_id`,`person_id`,`order_id`,`restaurant_id`,`restaurant_score`,`rate_comment`) VALUES (91,44,82,30,2,"eu, ultrices sit amet,"),(92,187,69,69,3,"dictum cursus."),(93,3,11,47,4,"Nunc mauris sapien, cursus in,"),(94,101,8,13,5,"interdum. Sed auctor"),(95,3,76,75,3,"dictum mi, ac mattis"),(96,74,37,59,4,"viverra. Donec tempus, lorem"),(97,132,6,95,2,"elementum, dui quis accumsan"),(98,90,21,41,4,"Aliquam auctor, velit eget laoreet"),(99,183,13,72,2,"vulputate, risus"),(100,40,15,77,4,"dui lectus rutrum urna, nec");

/*!40000 ALTER TABLE `restaurant_score` ENABLE KEYS */;
UNLOCK TABLES;
...
--
/*!50003 DROP PROCEDURE IF EXISTS `add_driver_score` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `add_restaurant_score` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `avg_driver_score` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `avg_restaurant_score` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
-- Dump completed on 2020-12-06 23:39:34
